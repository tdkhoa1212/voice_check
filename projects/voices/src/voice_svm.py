...
import random
from sklearn import svm  # https://scikit-learn.org/stable/modules/linear_model.html#ordinary-least-squares
import sys
...
def experiment_svm(wav_file, plot_state=True, inv_state=True):
...
def straighten(filename, plot_state=True, inv_state=True):
    ...
    if inv_state == True:
        ...
        return x_2, sample_rate
        

if __name__ == '__main__':
    wav_file = sys.argv[1]
    experiment_svm(wav_file, inv_state=False)